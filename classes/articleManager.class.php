...
// DECLARATION ET INSTANCIATIONS
    private $bdd; // Instanciations de PDO
    private $_result;
    private $_message;
    private $_article; // Instanciations de article
    ...
    // Fonction qui permet d'avoir un article à partir de son ID
    ...
    // Fonction qui permet d'avoir la liste de tous les articles
  ...
  public function getOneArt($id_article) {
    ...
    // Fonction d'ajout d'un article dans la BBD
    public function add(article $article) {
     ...
     // Fonction qui donne le nb d'articles publiés
    ...
    // Fonction qui permet d'avoir la liste des articles à afficher c'est à publé = 1
    ...
    // Fonction qui permet de mettre à jour les information d'un article
    ...
    //Fonction qui permet de rechercher un artcile à partir des mots présents dans celui-ci
